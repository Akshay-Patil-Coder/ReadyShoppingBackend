...
router.post('/cod/collect', authentication, cartsController.confirmCODCollection);
router.post('/cod/update-status', authentication, cartsController.updateCODOrderStatus);
